defmodule RegaliaWeb.UserAuth do
  ...
  alias Regalia.Accounts.Scope

  # Make the remember me cookie valid for 60 days.
  # If you want bump or reduce this value, also change
  # the token expiry itself in UserToken.
  @remember_me_cookie "_regalia_web_user_remember_me"
  ...
  the current_user:
      ...
      defmodule RegaliaWeb.PageLive do
        use RegaliaWeb, :live_view

        on_mount {RegaliaWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{RegaliaWeb.UserAuth, :ensure_authenticated}] do
